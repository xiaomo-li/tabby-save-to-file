...
@NgModule({
  ...
  providers: [
    {
      provide: TerminalContextMenuItemProvider,
      useClass: SaveOutputContextMenu,
      multi: true,
    },
    {
      provide: ConfigProvider,
      useClass: SaveOutputConfigProvider,
      multi: true,
    },
    {
      provide: SettingsTabProvider,
      useClass: SaveOutputSettingsTabProvider,
      multi: true,
    },
    { provide: TerminalDecorator, useClass: SaveOutputDecorator, multi: true },
  ],

  declarations: [SaveOutputSettingsTabComponent],
})
